...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || 'Privacy Policy', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || '/privacy', // 备案查询链接，如果用了萌备等备案请在这里填写
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || '© 2026 Savvy Travel. As an affiliate, I may earn a commission from qualifying purchases', // 公安备案号，例如 '浙公网安备3xxxxxxxx8号'
